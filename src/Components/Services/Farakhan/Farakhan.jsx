...
export default function Farakhan() {
  return (
    <div className="Farakhan text-center py-24 px-3 md:px-8 lg:px-12 xl:px-16 2xl:px-24 space-y-7">
      ...
      <p className="text-white font-bold text-center leading-10">
      ...
      <button className="border-2 border-white  bg-transparent text-white text-xl px-6 py-2 rounded-md hover:bg-Primary hover:text-white hover:border-Primary transition-all duration-300">
        فراخوانی برای اقدام
      </button>
    </div>
  );
